...
let achievementTitle = document.getElementById('achievementTitle');
let achievementMessage = document.getElementById('achievementMessage');

function checkTasks() {
    if (completedTasks >= 5 && achievements.champion == false) {
        achievements.champion = true;
        achievementTitle.innerHTML = 'Champion Achievement Unlocked:';
        achievementMessage.innerHTML = 'Complete 5 tasks';
        achievementTitle.classList.add('typing');
        setTimeout(function () {
            achievementMessage.classList.add('typing');
            achievementMessage.addEventListener('animationend', resetTypingAnimation);
        }, 3000)
    }
    if (completedTasks >= 10 && achievements.master == false) {
        achievements.master = true;
        achievementTitle.innerHTML = 'Master Achievement Unlocked:';
        achievementMessage.innerHTML = 'Complete 10 tasks';
        achievementTitle.classList.add('typing');
        setTimeout(function () {
            achievementMessage.classList.add('typing');
            achievementMessage.addEventListener('animationend', resetTypingAnimation);
    ...
    if (deletedTask == 3 && achievements.purge == false) {
        achievements.purge = true;
        achievementTitle.innerHTML = 'Purge Achievement Unlocked:';
        achievementMessage.innerHTML = 'Remove 3 tasks';
        achievementTitle.classList.add('typing');
        setTimeout(function () {
            achievementMessage.classList.add('typing');
            achievementMessage.addEventListener('animationend', resetTypingAnimation);
...
function resetTypingAnimation() {
    achievementTitle.classList.remove('typing');
    achievementMessage.classList.remove('typing');
    void achievementTitle.offsetWidth;
    void achievementMessage.offsetWidth;
}